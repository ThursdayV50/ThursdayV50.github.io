	...
	if (!($.cookie('tp_stylesheet'))) {
		...
		if (link.length > 0) {
			...
			if ($(".swicher-title-page-dark").length > 0) {
				document.getElementById("logo_img").src = "img/customizer/logo/logo_dark_swicher-title_" + tp_stylesheet + ".jpg";
			} else {
				if ($("#logo_img").length > 0) {
					document.getElementById("logo_img").src = "img/customizer/logo/logo_" + tp_stylesheet + ".jpg";
				};
				if ($("#logo_dark_img").length > 0) {
					document.getElementById("logo_dark_img").src = "img/customizer/logo/dark/logo_" + tp_stylesheet + ".jpg";
				};
				if ($("#logo-footer").length > 0) {
					document.getElementById("logo-footer").src = "img/customizer/logo/logo_" + tp_stylesheet + ".jpg";
				};
			};
		};
	};
...
*************************/
	$('.style-customizer .styleChange li').on('click', function () {
		if (link.length > 0) {
			...
			if ($(".swicher-title-page-dark").length > 0) {
				document.getElementById("logo_img").src = "img/customizer/logo/logo_dark_swicher-title_" + tp_stylesheet_no_cookie + ".jpg";
			} else {
				if ($("#logo_img").length > 0) {
					document.getElementById("logo_img").src = "img/customizer/logo/logo_" + tp_stylesheet_no_cookie + ".jpg";
				};
				if ($("#logo_dark_img").length > 0) {
					document.getElementById("logo_dark_img").src = "img/customizer/logo/dark/logo_" + tp_stylesheet_no_cookie + ".jpg";
				};
				if ($("#logo-footer").length > 0) {
					document.getElementById("logo-footer").src = "img/customizer/logo/logo_" + tp_stylesheet_no_cookie + ".jpg";
				};
			};
		};
	});
